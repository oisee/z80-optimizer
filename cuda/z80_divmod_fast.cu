...
// Reduced 14-op pool (7 never-used ops removed)
...
#define OP_SRL_A     8   // SRL A     (8T)
#define OP_RLA       9   // RLA       (4T)
#define OP_RRA      10   // RRA       (4T)
#define OP_RLCA     11   // RLCA      (4T)
#define OP_RRCA     12   // RRCA      (4T)
#define OP_NEG      13   // NEG       (8T)
// Dead ops (indices >= NUM_OPS, never generated)
#define OP_SLA_A    14
#define OP_SRA_A    15
#define OP_RLC_A    16
#define OP_RRC_A    17
