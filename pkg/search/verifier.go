...
var TestVectors = []cpu.State{
	{A: 0x00, F: 0x00, B: 0x00, C: 0x00, D: 0x00, E: 0x00, H: 0x00, L: 0x00, SP: 0x0000, M: 0x42},
	{A: 0xFF, F: 0xFF, B: 0xFF, C: 0xFF, D: 0xFF, E: 0xFF, H: 0xFF, L: 0xFF, SP: 0xFFFF, M: 0xBD},
	{A: 0x01, F: 0x00, B: 0x02, C: 0x03, D: 0x04, E: 0x05, H: 0x06, L: 0x07, SP: 0x1234, M: 0x13},
	{A: 0x80, F: 0x01, B: 0x40, C: 0x20, D: 0x10, E: 0x08, H: 0x04, L: 0x02, SP: 0x8000, M: 0x7E},
	{A: 0x55, F: 0x00, B: 0xAA, C: 0x55, D: 0xAA, E: 0x55, H: 0xAA, L: 0x55, SP: 0x5555, M: 0xA5},
	{A: 0xAA, F: 0x01, B: 0x55, C: 0xAA, D: 0x55, E: 0xAA, H: 0x55, L: 0xAA, SP: 0xAAAA, M: 0x5A},
	{A: 0x0F, F: 0x00, B: 0xF0, C: 0x0F, D: 0xF0, E: 0x0F, H: 0xF0, L: 0x0F, SP: 0xFFFE, M: 0xE1},
	{A: 0x7F, F: 0x01, B: 0x80, C: 0x7F, D: 0x80, E: 0x7F, H: 0x80, L: 0x7F, SP: 0x7FFF, M: 0x33},
}

// MidCheckVectors are 32 vectors used as a cheap intermediate filter between
// QuickCheck (8 vectors) and ExhaustiveCheck (full sweep). The extra 24 vectors
// add single-bit A values and per-register bit coverage that catch BIT/RES/SET
// false positives which collide on the original 8 vectors (~27% false positive
// rate reduced to <1%).
var MidCheckVectors = []cpu.State{
	// --- Original 8 vectors (same as QuickCheck) ---
	{A: 0x00, F: 0x00, B: 0x00, C: 0x00, D: 0x00, E: 0x00, H: 0x00, L: 0x00, SP: 0x0000, M: 0x42},
	{A: 0xFF, F: 0xFF, B: 0xFF, C: 0xFF, D: 0xFF, E: 0xFF, H: 0xFF, L: 0xFF, SP: 0xFFFF, M: 0xBD},
	{A: 0x01, F: 0x00, B: 0x02, C: 0x03, D: 0x04, E: 0x05, H: 0x06, L: 0x07, SP: 0x1234, M: 0x13},
	{A: 0x80, F: 0x01, B: 0x40, C: 0x20, D: 0x10, E: 0x08, H: 0x04, L: 0x02, SP: 0x8000, M: 0x7E},
	...
	{A: 0x0F, F: 0x00, B: 0xF0, C: 0x0F, D: 0xF0, E: 0x0F, H: 0xF0, L: 0x0F, SP: 0xFFFE, M: 0xE1},
	{A: 0x7F, F: 0x01, B: 0x80, C: 0x7F, D: 0x80, E: 0x7F, H: 0x80, L: 0x7F, SP: 0x7FFF, M: 0x33},
	// --- Single-bit A values (vectors 8-15) ---
	{A: 0x02, F: 0x00, B: 0x01, C: 0x02, D: 0x04, E: 0x08, H: 0x10, L: 0x20, SP: 0x0102, M: 0x91},
	{A: 0x04, F: 0x01, B: 0x08, C: 0x10, D: 0x20, E: 0x40, H: 0x80, L: 0x01, SP: 0x0408, M: 0x48},
	{A: 0x08, F: 0x00, B: 0x10, C: 0x20, D: 0x40, E: 0x80, H: 0x01, L: 0x02, SP: 0x1020, M: 0x24},
	{A: 0x10, F: 0x01, B: 0x20, C: 0x40, D: 0x80, E: 0x01, H: 0x02, L: 0x04, SP: 0x4080, M: 0xD7},
	{A: 0x20, F: 0x00, B: 0x40, C: 0x80, D: 0x01, E: 0x02, H: 0x04, L: 0x08, SP: 0x0201, M: 0x6B},
	{A: 0x40, F: 0x01, B: 0x80, C: 0x01, D: 0x02, E: 0x04, H: 0x08, L: 0x10, SP: 0x8040, M: 0xB2},
	{A: 0x03, F: 0x00, B: 0x05, C: 0x09, D: 0x11, E: 0x21, H: 0x41, L: 0x81, SP: 0x0309, M: 0x0F},
	{A: 0x05, F: 0x01, B: 0x0A, C: 0x14, D: 0x28, E: 0x50, H: 0xA0, L: 0x41, SP: 0x0A14, M: 0xF0},
	// --- Per-register bit coverage (vectors 16-23) ---
	{A: 0x11, F: 0x00, B: 0x01, C: 0x02, D: 0x04, E: 0x08, H: 0x10, L: 0x20, SP: 0x0100, M: 0xC3},
	{A: 0x22, F: 0x01, B: 0x04, C: 0x08, D: 0x10, E: 0x20, H: 0x40, L: 0x80, SP: 0x0200, M: 0x3C},
	{A: 0x44, F: 0x00, B: 0x10, C: 0x20, D: 0x40, E: 0x80, H: 0x01, L: 0x02, SP: 0x0400, M: 0x87},
	{A: 0x88, F: 0x01, B: 0x40, C: 0x80, D: 0x01, E: 0x02, H: 0x04, L: 0x08, SP: 0x0800, M: 0x69},
	{A: 0x33, F: 0x00, B: 0x03, C: 0x0C, D: 0x30, E: 0xC0, H: 0x05, L: 0x0A, SP: 0x3300, M: 0xAE},
	{A: 0xCC, F: 0x01, B: 0x30, C: 0xC0, D: 0x03, E: 0x0C, H: 0x50, L: 0xA0, SP: 0xCC00, M: 0x51},
	{A: 0x66, F: 0x00, B: 0x06, C: 0x60, D: 0x09, E: 0x90, H: 0x0C, L: 0xC0, SP: 0x6600, M: 0xDA},
	{A: 0x99, F: 0x01, B: 0x09, C: 0x90, D: 0x06, E: 0x60, H: 0xA0, L: 0x0A, SP: 0x9900, M: 0x25},
	// --- Boundary values (vectors 24-31) ---
	{A: 0xFE, F: 0x00, B: 0x7F, C: 0x80, D: 0x01, E: 0xFE, H: 0x55, L: 0xAA, SP: 0x0001, M: 0x01},
	{A: 0x81, F: 0x01, B: 0xFE, C: 0x01, D: 0x80, E: 0x7F, H: 0xAA, L: 0x55, SP: 0x8001, M: 0xFE},
	{A: 0x7E, F: 0x00, B: 0x81, C: 0x42, D: 0x24, E: 0x18, H: 0xE7, L: 0xDB, SP: 0x7FFE, M: 0x80},
	{A: 0xBF, F: 0x01, B: 0x40, C: 0xBF, D: 0x40, E: 0xBF, H: 0x40, L: 0xBF, SP: 0xBF00, M: 0x40},
	{A: 0xC0, F: 0x00, B: 0x3F, C: 0xC0, D: 0x3F, E: 0xC0, H: 0x3F, L: 0xC0, SP: 0xC000, M: 0x1F},
	{A: 0xE0, F: 0x01, B: 0x1F, C: 0xE0, D: 0x1F, E: 0xE0, H: 0x1F, L: 0xE0, SP: 0xE000, M: 0xEF},
	{A: 0xF0, F: 0x00, B: 0x0F, C: 0xF0, D: 0x0F, E: 0xF0, H: 0x0F, L: 0xF0, SP: 0xF000, M: 0x55},
	{A: 0x0E, F: 0x01, B: 0xE0, C: 0x0E, D: 0xE0, E: 0x0E, H: 0xE0, L: 0x0E, SP: 0x0E0E, M: 0xAA},
}
...
// Runs on QuickCheck survivors to filter false positives before ExhaustiveCheck.
...
// MidCheckMasked tests two sequences against the 32 MidCheck vectors,
// ignoring dead flag bits.
...
const (
	...
	regL
	regSP
	regM // Wave 5: virtual memory byte
)
...
func opReads(op inst.OpCode) regMask {
	...
	// Wave 5: Memory ops — read M (virtual memory byte)
	// LD r, (HL) / LD A, (BC) / LD A, (DE): read M
	case inst.LD_A_HLI, inst.LD_B_HLI, inst.LD_C_HLI, inst.LD_D_HLI,
		inst.LD_E_HLI, inst.LD_H_HLI, inst.LD_L_HLI,
		inst.LD_A_BCI, inst.LD_A_DEI:
		return regM
	// LD (HL), r: read the source register (M is written, not read)
	case inst.LD_HLI_A, inst.LD_BCI_A, inst.LD_DEI_A:
		return regA
	case inst.LD_HLI_B:
		return regB
	case inst.LD_HLI_C:
	...
	case inst.ADD_A_HLI, inst.SUB_HLI, inst.AND_HLI, inst.XOR_HLI, inst.OR_HLI, inst.CP_HLI:
		return regA | regM
	// ADC/SBC A, (HL): read A + M + F
	case inst.ADC_A_HLI, inst.SBC_A_HLI:
		return regA | regM | regF
	// INC/DEC (HL): read M
	case inst.INC_HLI, inst.DEC_HLI:
		return regM
	// Rotate/shift (HL): read M (RR/RL also read F)
	case inst.RLC_HLI, inst.RRC_HLI, inst.SLA_HLI, inst.SRA_HLI, inst.SRL_HLI, inst.SLL_HLI:
		return regM
	case inst.RL_HLI, inst.RR_HLI:
		return regM | regF
	// BIT n, (HL): read M (flags only)
	case inst.BIT_0_HLI, inst.BIT_1_HLI, inst.BIT_2_HLI, inst.BIT_3_HLI,
		inst.BIT_4_HLI, inst.BIT_5_HLI, inst.BIT_6_HLI, inst.BIT_7_HLI:
		return regM
	// RES/SET n, (HL): read M (modify M)
	case inst.RES_0_HLI, inst.RES_1_HLI, inst.RES_2_HLI, inst.RES_3_HLI,
	...
	// Remaining: NOP, LD r,n, LD rr,nn, LD (HL),n, ADD A,n, SUB n, AND n, XOR n, OR n, CP n don't read extra regs
	}
	return 0
}
...
func exhaustiveAll(target, candidate []inst.Instruction, reads regMask) bool {
	...
	extraRegs := make([]int, 0, 7) // offsets of registers to sweep
	if reads&regB != 0 {
	...
	if reads&regM != 0 {
		extraRegs = append(extraRegs, 10) // M offset
	}
